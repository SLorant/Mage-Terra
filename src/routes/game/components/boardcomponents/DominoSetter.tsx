import { DominoState } from "../../../../components/Interfaces";
...
export const DominoSetter = (): DominoState => {
  ...
  const [randomName, randomName2] = [
    nameArray[randomItemIndex],
    nameArray[randomItemIndex2],
  ];
  const [randomImg, randomImg2] = [
    imgArray[randomItemIndex][randomImage],
    imgArray[randomItemIndex2][randomImage2],
  ];
  const Domino: DominoState = {
    firstname: randomName,
    img: randomImg,
    secondname: randomName2,
    secondimg: randomImg2,
  };
  return Domino;
};
