...
import { MapSetterProps, SquareState } from "../../../../components/Interfaces";
import { onValue, ref, set } from "firebase/database";
import { projectDatabase } from "../../../../../firebase/config";
import { useState, useEffect } from "react";

export const useMapSetter = ({
  Squares,
  uniqueId,
  room,
  victory,
}: MapSetterProps): SquareState[] => {
    ...
    switch (mapCode) {
      case 1: {
        ...
        const newSquares = update(Squares, {
          [12]: {
            lastDroppedItem: {
              $set: { firstname: "Dungeon", img: "/dominoes/dungeon-05.webp" },
            },
          },
          [28]: {
            lastDroppedItem: {
              $set: { firstname: "Lagoon", img: "/dominoes/lagoon-02.webp" },
            },
          },
          [24]: {
            lastDroppedItem: {
              $set: {
                firstname: "DungeonLagoonMtVillageFieldRuin",
                img: "/dominoes/tower.webp",
              },
            },
          },
          [3]: { hasStar: { $set: true } },
      ...
      case 2: {
        ...
        const newSquares = update(Squares, {
          [1]: {
            lastDroppedItem: {
              $set: { firstname: "Field", img: "/dominoes/field-03.webp" },
            },
          },
          [28]: {
            lastDroppedItem: {
              $set: { firstname: "Village", img: "/dominoes/village-02.webp" },
            },
          },
          [41]: {
            lastDroppedItem: {
              $set: { firstname: "Mt", img: "/dominoes/mountain-01.webp" },
            },
          },
          [24]: {
            lastDroppedItem: {
