...
const ParallaxImages = () => {
  ...
  return (
    <div>
      <div className="w-[820px] h-[1150px] sm:w-[1000px] sm:h-[1400px] absolute md:-top-16 top-72 sm:top-40 -left-36 sm:-left-24 lg:left-0 xl:left-14 2xl:left-20 z-10 sm:z-0 parallax">
      ...
      <div className="w-[700px] h-[1200px]  sm:w-[850px] sm:h-[1400px] absolute -top-24 -right-40 sm:-top-20 sm:-right-40 lg:-right-4 xl:right-20 2xl:right-20 z-0 parallax">
