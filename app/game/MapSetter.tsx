...
export const MapSetter = (Squares: SquareState[]): SquareState[] => {
  ...
  const newSquares = update(Squares, {
    [4]: { lastDroppedItem: { $set: { firstname: 'F', img: '/cave-05.svg' } } },
    [25]: { lastDroppedItem: { $set: { firstname: 'W', img: '/swamp-02.svg' } } },
    [55]: { lastDroppedItem: { $set: { firstname: 'C', img: '/mountains-01.svg' } } },
